...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.BetterChatSupport_gutenberg_blocks ) { return; }

  Object.values(window.BetterChatSupport_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType(block.name, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'better-chat-support-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.name,
              className: 'is-secondary better-chat-support-shortcode-button',
              onClick: function () {
                window.BetterChatSupport_gutenberg_props = props;
              },
            }, block.button_title ),
