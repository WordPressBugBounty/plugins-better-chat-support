...
(function($) {
  ...
  function BetterChatSupportAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  BetterChatSupportAjaxChosen.prototype.init = function() {
  ...
  BetterChatSupportAjaxChosen.prototype.events = function() {
  ...
  BetterChatSupportAjaxChosen.prototype.search_field_focused = function() {
  ...
  BetterChatSupportAjaxChosen.prototype.search_welcome_message = function() {
  ...
  BetterChatSupportAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('better-chat-support-chosen', _this.options.data).done( function( response ) {
  ...
  BetterChatSupportAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.better-chat-support-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.BetterChatSupportChosenOrder($hidden_value, true);
  ...
  $.fn.BetterChatSupportAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new BetterChatSupportAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, BetterChatSupportAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  BetterChatSupportAbstractChosenOrder = (function() {

    function BetterChatSupportAbstractChosenOrder() {}

    BetterChatSupportAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    BetterChatSupportAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    BetterChatSupportAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    BetterChatSupportAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    BetterChatSupportAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    BetterChatSupportAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    BetterChatSupportAbstractChosenOrder.BetterChatSupportChosenOrder = function(select, order, force) {
    ...
    return BetterChatSupportAbstractChosenOrder;
  ...
  $.fn.extend({
    BetterChatSupportChosenOrder: function(order, force) {
      return _BetterChatSupportChosenOrder.BetterChatSupportChosenOrder(this, order, force);
    }
  });

  this._BetterChatSupportChosenOrder = (function(_super) {
    __extends(_BetterChatSupportChosenOrder, _super);

    function _BetterChatSupportChosenOrder() {
      _ref = _BetterChatSupportChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _BetterChatSupportChosenOrder.relAttributeName = 'data-option-array-index';

    _BetterChatSupportChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _BetterChatSupportChosenOrder.getDOMElement = function(element) {
    ...
    _BetterChatSupportChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _BetterChatSupportChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _BetterChatSupportChosenOrder;

  })(BetterChatSupportAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('better-chat-support-depend-on');
        });
        ...
        $(controls).each(function() {
          $(this).addClass('better-chat-support-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectBetterChatSupport = FormSerializer.serializeObject;
    $.fn.serializeJSONBetterChatSupport   = FormSerializer.serializeJSON;
  }
