 ...
 *
 */
if ( ! class_exists( 'BetterChatSupport_Fields' ) ) {
  abstract class BetterChatSupport_Fields extends BetterChatSupport_Abstract {
    protected $field;
    protected $value;
    protected $unique;
    protected $where;
    ...
    public function field_before() {
      return ( ! empty( $this->field['before'] ) ) ? '<div class="better-chat-support-before-text">'. $this->field['before'] .'</div>' : '';
    }

    public function field_after() {

      $output  = ( ! empty( $this->field['after'] ) ) ? '<div class="better-chat-support-after-text">'. $this->field['after'] .'</div>' : '';
      $output .= ( ! empty( $this->field['desc'] ) ) ? '<div class="clear"></div><div class="better-chat-support-desc-text">'. $this->field['desc'] .'</div>' : '';
      $output .= ( ! empty( $this->field['help'] ) ) ? '<div class="better-chat-support-help"><span class="better-chat-support-help-text">'. $this->field['help'] .'</span><i class="icofont-question-circle"></i></div>' : '';
      $output .= ( ! empty( $this->field['_error'] ) ) ? '<div class="better-chat-support-error-text">'. $this->field['_error'] .'</div>' : '';
