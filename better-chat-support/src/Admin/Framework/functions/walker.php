 ...
 *
 */
if ( ! class_exists( 'BetterChatSupport_Walker_Nav_Menu_Edit' ) && class_exists( 'Walker_Nav_Menu_Edit' ) ) {
  class BetterChatSupport_Walker_Nav_Menu_Edit extends Walker_Nav_Menu_Edit {
