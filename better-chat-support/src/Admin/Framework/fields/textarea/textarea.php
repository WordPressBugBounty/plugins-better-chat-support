...
if ( ! class_exists( 'BetterChatSupport_Field_textarea' ) ) {
  class BetterChatSupport_Field_textarea extends BetterChatSupport_Fields {
    ...
    public function shortcoder() {
      ...
      if ( ! empty( $this->field['shortcoder'] ) ) {
        ...
        $instances  = ( ! empty( BetterChatSupport::$shortcode_instances ) ) ? BetterChatSupport::$shortcode_instances : array();
          ...
          foreach ( $shortcodes as $shortcode ) {
            ...
            foreach ( $instances as $instance ) {
              ...
              if ( $instance['modal_id'] === $shortcode ) {
                ...
                echo '<a href="#" class="button button-primary better-chat-support-shortcode-button" data-modal-id="'. esc_attr( $id ) .'">'. esc_html( $title ) .'</a>';
