 ...
 *
 */
if ( ! class_exists( 'BetterChatSupport_Field_upload' ) ) {
  class BetterChatSupport_Field_upload extends BetterChatSupport_Fields {
    ...
    public function render() {
      ...
      if ( ! empty( $args['preview'] ) ) {
        ...
        echo '<div class="better-chat-support--preview'. esc_attr( $preview_hidden ) .'">';
        echo '<div class="better-chat-support-image-preview"'. wp_kses_post($preview_style) .'>';
        echo '<i class="better-chat-support--remove icofont-close"></i><span><img src="'. esc_url( $preview_src ) .'" class="better-chat-support--src" /></span>';
        echo '</div>';
        echo '</div>';
      ...
      echo '<a href="#" class="button button-primary better-chat-support--button" data-library="'. esc_attr( $library ) .'">'. esc_html($args['button_title']) .'</a>';
      echo '<a href="#" class="button button-secondary better-chat-support-warning-primary better-chat-support--remove'. esc_attr( $hidden ) .'">'. wp_kses_post($args['remove_title']) .'</a>';
      echo '</div>';
