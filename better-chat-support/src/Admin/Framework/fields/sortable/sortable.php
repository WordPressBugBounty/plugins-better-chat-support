...
if ( ! class_exists( 'BetterChatSupport_Field_sortable' ) ) {
  class BetterChatSupport_Field_sortable extends BetterChatSupport_Fields {
    ...
    public function render() {
      ...
      echo '<div class="better-chat-support-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="better-chat-support-sortable-item">';

          echo '<div class="better-chat-support-sortable-content">';
          ...
          BetterChatSupport::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="better-chat-support-sortable-helper"><i class="icofont-drag"></i></div>';
