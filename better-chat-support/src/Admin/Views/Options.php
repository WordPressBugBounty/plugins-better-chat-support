 ...
 * @subpackage better-chat-support/Admin/Views/Options
 * @author     ThemeAtelier<themeatelierbd@gmail.com>
 */

namespace ThemeAtelier\BetterChatSupport\Admin\Views;

use ThemeAtelier\BetterChatSupport\Admin\Views\General;
...
class Options
{
    ...
    public static function options($prefix)
    {
        ...
        BetterChatSupport::createOptions($prefix, array(
            ...
            'admin_bar_menu_priority' => 58,
            'footer_text'             => esc_html__('Thank you for using our product', 'better-chat-support'),
            'theme'                   => 'light',
            'nav'                     => 'inline',
            'framework_class'         => 'better-chat-support-admin',
            'class'                    => 'better-chat-preloader',
        ));
