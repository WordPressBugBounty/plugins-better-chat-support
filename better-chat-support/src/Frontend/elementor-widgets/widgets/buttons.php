...
class Mcs_Buttons extends Widget_Base
{
    ...
    {
        return 'Better Chat Support Button';
    }
        ...
        $this-> add_control(
            'button__sizes', [
                ...
                'options' => array(
                    ...
                    'medium' => esc_html__( 'Large', 'better-chat-support' ),
                )
            ]
        );
    ...
    protected function render()
    {
        ...
        $button__icon = isset($settings['button__icon']) ? $settings['button__icon'] : '';
        $icon = isset($button__icon['value']) ? $button__icon['value'] : '';
        $rounded = $settings['rounded'];
        $icon__bg = $settings['show__icon__bg__color'];
        $sizes = $settings['button__sizes'];
        $agent__photo = $settings['agent__photo'];
        $photo = isset($agent__photo['url']) ? $agent__photo['url'] : '';
        ...
        <?php else : ?>
            <div class="button-wrapper">
                ...
                <i class="<?php echo esc_attr($mcsIcon);?>"></i> <?php if( $labelText ) { ?><span><?php echo esc_html( $labelText ); ?></span><?php } ?>
                </a>
            </div>
        <?php endif;
    }
