 ...
 * @subpackage better-chat-support/src/Admin/Helpers
	...
	public function get_active_offers() {
		...
		$offers = array(
			'new_year'     => array(
				...
				'image' => MCS_DIR_URL . 'admin/assets/images/messenger-ny-banner.svg',
				'link'  => 'https://themeatelier.net/downloads/better-chat-support-for-messenger/?utm_source=better_chat_support_plugin&utm_medium=offer_banner&utm_campaign=new_year_2026',
			),
		);
